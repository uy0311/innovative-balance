...
NNavy = {
	...
	COMBAT_BASE_CRITICAL_CHANCE = 0.025,								-- Base chance for receiving a critical chance. It get's scaled down with ship reliability.
	COMBAT_CRITICAL_DAMAGE_MULT = 5.0,								-- Multiplier for the critical damage. Scaled down with the ship reliability.
	COMBAT_ARMOR_PIERCING_CRITICAL_BONUS = 4.0,						-- Bonus to critical chance when shooter armor piercing is higher then target armor.
	...
	MAX_CARRIER_RATIO_POSITIONING_PENALTY_FACTOR 					= 4.0;  -- max penalty from stronger carrier air force
