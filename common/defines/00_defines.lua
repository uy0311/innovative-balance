...
NMilitary = {
	...
	BASE_DIVISION_BRIGADE_GROUP_COST = 12, 	--Base cost to unlock a regiment slot,
	...
	LAND_AIR_COMBAT_STR_DAMAGE_MODIFIER = 0.064,    --0.08 air global damage modifier
	LAND_AIR_COMBAT_ORG_DAMAGE_MODIFIER = 0.032,    --0.04 global damage modifier
...
NNavy = {
	...
	COORDINATION_EFFECT_ON_MINE_SWEEPING_SUPREMACY_EFFICIENCY		= 0.0,      -- mine missions supremacy can be buffed by coordination
	COORDINATION_EFFECT_ON_MINE_PLANTING_SUPREMACY_EFFICIENCY		= 0.0,      -- mine missions supremacy can be buffed by coordination
	...
	NAVAL_COMBAT_AIR_CAPITAL_TARGET_SCORE = 50.0,
	NAVAL_COMBAT_AIR_CARRIER_TARGET_SCORE = 10.0,
	NAVAL_COMBAT_AIR_CONVOY_TARGET_SCORE = 10.0,
...
NIntel = {
	...
	NAVAL_SUPREMACY_INTEL_LOW = 0.0,								-- we need more intel than this to get any supremacy
	NAVAL_SUPREMACY_INTEL_LOW_SUPREMACY_PENALTY_START = 0.0,		-- supremacy is reduced to NAVAL_SUPREMACY_INTEL_LOW_SUPREMACY_MIN_PENALTY at or below this intel
	NAVAL_SUPREMACY_INTEL_LOW_SUPREMACY_MIN_PENALTY = 1.0, -- you get this much supremacy at NAVAL_SUPREMACY_INTEL_LOW_SUPREMACY_PENALTY_START and scales up to 1 at NAVAL_SUPREMACY_INTEL_LOW
