...
NMilitary = {
	...
	LAND_AIR_COMBAT_ORG_DAMAGE_MODIFIER = 0.12,    	-- air global organization damage modifier
	LAND_AIR_COMBAT_MAX_PLANES_PER_ENEMY_WIDTH = 1.0, -- how many CAS/TAC can enter a combat depending on enemy width there
