...
NCountry = {
	...
	BOMBING_WAR_SUPPORT_PENALTY_SCALE = 0.00, 			-- Scaling of bomber damage to war support impact, will be added weekly as a war support penalty
	MAX_BOMBING_WEEKLY_WAR_SUPPORT_PENALTY = 0.0,		-- Max penalty that will gained per week from bomber's damage
	BOMBING_WEEKLY_WAR_SUPPORT_PENALTY_DECAY = 0.00,		-- Weekly decay of bomber damage war support penalty
	MAX_BOMBING_WAR_SUPPORT_IMPACT = 0.0,					-- Max total penalty from bomber's damage
...
NMilitary = {
	...
	LAND_AIR_COMBAT_ORG_DAMAGE_MODIFIER = 0.020,    -- global damage modifier
...
NAir = {
	...
	ANTI_AIR_ATTACK_TO_DAMAGE_REDUCTION_FACTOR = 0.4,	-- Balancing value to convert equipment stat anti_air_attack to the damage reduction modifier apply to incoming air attacks against units with AA.
...
NNavy = {
	...
	ANTI_AIR_TARGETTING_TO_CHANCE = 0.3,							-- Balancing value to convert averaged equipment stats (anti_air_targetting and naval_strike_agility) to probability chances of airplane being hit by navies AA.
	...
	TRAINING_EXPERIENCE_FACTOR = 0.1,								-- Amount of exp each ship gain every 24h while training (before modifiers)
