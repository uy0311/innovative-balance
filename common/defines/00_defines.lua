...
NCountry = {
	...
	BOMBING_WEEKLY_WAR_SUPPORT_PENALTY_DECAY = 0.0,		-- Weekly decay of bomber damage war support penalty
...
NProduction = {
	...
	BASE_FACTORY_SPEED_NAV = 5.0, 				-- Base factory speed multiplier (how much hoi3 style IC each factory gives).
...
NMilitary = {
	...
	COMBAT_STACKING_START = 24,						-- at what nr of divisions stacking penalty starts
...
NAir = {
	...
	PORT_STRIKES_DELAY_MULTIPLIER = 1,					-- multplies HOURS_DELAY_AFTER_EACH_COMBAT if port strikes
	...
	AIR_AGILITY_TO_NAVAL_STRIKE_AGILITY = 0.0425,         		-- conversion factor to bring agility in line with ship AA
	...
	AIR_WING_ATTACK_LOGISTICS_NO_TRUCK_DISRUPTION_FACTOR = 0.06, -- 0.10 If a unit isn't motorized, still disrupt its supply by damage * this
	...
	AIR_WING_ATTACK_LOGISTICS_TRAIN_DAMAGE_FACTOR = 0.15, --0.065
	...
	AIR_WING_ATTACK_LOGISTICS_RAILWAY_DAMAGE_SPILL_FACTOR = 0.00, -- 0.003 Portion of train damage to additionally deal to railways
	...
	FUEL_COST_MULT = 0.70, -- fuel multiplier for all air missions

	MISSION_EFFICIENCY_MULT_AT_LACK_OF_FUEL = 0.00, 				-- multiplier for mission efficiency when a base lacks fuel

	BOMBING_TARGETING_RANDOM_FACTOR = 0.0,							-- % of picking the wrong target
...
NNavy = {
	...
	FIELD_EXPERIENCE_SCALE = 0.45,
	FIELD_EXPERIENCE_MAX_PER_DAY = 500,								-- Most xp you can gain per day
	LEADER_EXPERIENCE_SCALE = 1.0,
...
NIntel = {
	...
	ARMY_SPECIAL_FORCES_COUNT_RANGE_INTEL_RANGE_AT_LOWEST_INTEL = 0.45,
	...
	ARMY_MIN_INTEL_TO_SHOW_EQUIPMENT_RATIO = 0.80,
...
NSupply = {
	...
	AVAILABLE_MANPOWER_STATE_SUPPLY = 0.0,						--Factor for state supply from max manpower (population)
