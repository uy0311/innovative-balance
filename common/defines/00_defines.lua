...
NMilitary = {
	...
	LAND_AIR_COMBAT_STR_DAMAGE_MODIFIER = 0.10,    -- air global strength damage modifier
	LAND_AIR_COMBAT_ORG_DAMAGE_MODIFIER = 0.08,    	-- air global organization damage modifier
