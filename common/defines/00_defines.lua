...
NGame = {
	...
	LAG_DAYS_FOR_LOWER_SPEED = 40,					-- Days of client lag for decrease of gamespeed
	LAG_DAYS_FOR_PAUSE = 100,						-- Days of client lag for pause of gamespeed.
	GAME_SPEED_SECONDS = { 0.5, 0.3, 0.2, 0.08, 0.05 }, -- game speeds for each level. Must be 5 entries with last one 0 for unbound
...
NMilitary = {
	...
	LAND_AIR_COMBAT_STR_DAMAGE_MODIFIER = 0.064,    -- air global damage modifier
	LAND_AIR_COMBAT_ORG_DAMAGE_MODIFIER = 0.032,    -- global damage modifier
	LAND_AIR_COMBAT_MAX_PLANES_PER_ENEMY_WIDTH = 0.5, -- how many CAS/TAC can enter a combat depending on enemy width there
