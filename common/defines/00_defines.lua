...
NSupply = {
	...
	TRAIN_ANTI_AIR_ATTACK_TO_AMOUNT = 0.0015, -- Balancing value to convert the hitting air_attack to a percentage value of the attacking planes that are killed.
