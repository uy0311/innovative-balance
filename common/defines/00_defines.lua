...
NAir = {
	...
	COMBAT_BETTER_AGILITY_DAMAGE_REDUCTION = 2.25, 		-- How much the better agility (than opponent's) can reduce their damage to us.
	COMBAT_BETTER_SPEED_DAMAGE_INCREASE = 1.3, 			-- How much the better Speed (than opponent's) can reduce increase our damage to them.
