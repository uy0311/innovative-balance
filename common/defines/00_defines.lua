...
NCountry = {
	...
	NUCLEAR_PRODUCTION_SCALE = 1460,					-- +1 nuclear_production gives 1 nuke per year
	NUCLEAR_BOMB_DROP_WAR_SUPPORT_EFFECT_MAX_INFRA = 0, -- Reduce enemy national war support on nuking a province, the value scales with infrastructure up to this number
...
NMarket = {
	...
	MAX_CIV_FACTORIES_PER_CONTRACT = 100,							-- Max number of factories that can be assigned for paying single contract.
...
NAir = {
	...
	AIR_WING_BOMB_DAMAGE_FACTOR = 2.0,					-- Used to balance the damage done while bombing.
	...
	BOMBING_TARGETING_RANDOM_FACTOR = 0.00,							-- % of picking the wrong target
	...
	BOMBING_INFRA_PRIO_SCALE = 0.0,									-- Scale of the selected priority for infastryctyre
