...
NProduction = {
	...
	BASE_FACTORY_SPEED_NAV = 4.5, 				-- Base factory speed multiplier (how much hoi3 style IC each factory gives).
...
NMilitary = {
	...
	FIELD_EXPERIENCE_MAX_PER_DAY = 0.75,				-- Most xp you can gain per day
...
NAir = {
	...
	NAVAL_STRIKE_CARRIER_MULTIPLIER = 1.0,              -- damage bonus when planes are in naval combat where their carrier is present (and can thus sortie faster and more effectively)
...
NNavy = {
	...
	ANTI_AIR_TARGETTING_TO_CHANCE = 0.8,							-- Balancing value to convert averaged equipment stats (anti_air_targetting and naval_strike_agility) to probability chances of airplane being hit by navies AA.
