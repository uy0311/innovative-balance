...
NMilitary = {
	...
	LAND_COMBAT_ORG_DAMAGE_MODIFIER = 0.0625,       -- global damage modifier
	LAND_AIR_COMBAT_STR_DAMAGE_MODIFIER = 0.25,    -- air global damage modifier
	LAND_AIR_COMBAT_ORG_DAMAGE_MODIFIER = 0.01,    -- global damage modifier
