...
NDiplomacy = {
	...
	ASSUME_FACTION_SPYMASTER_COOLDOWN_DAYS = 0,			-- Number of days after change of Spy Master before another country is allowed to become Spy Master.
...
NMarket = {
	PURCHASE_CONTRACT_DELIVERY_TOTAL_DAYS = 5000,                   	-- Number of days between purchase contract deliveries
	IC_TO_CIC_FACTOR = 2.0,                    						-- The factor for mapping IC cost to CIC cost. Should be a positive number.
	MAX_CIV_FACTORIES_PER_CONTRACT = 1,							-- Max number of factories that can be assigned for paying single contract.
...
NMilitary = {
	...
	UNIT_EXPERIENCE_PER_COMBAT_HOUR = 0.00005,
...
NAir = {
	...
	AIR_WING_BOMB_DAMAGE_FACTOR = 0.25,					-- Used to balance the damage done while bombing.
	...
	COMBAT_DAMAGE_SCALE = 0.42,							-- Higher value = more shot down planes
	COMBAT_DAMAGE_SCALE_CARRIER = 5.25,					-- same as above but used inside naval combat for carrier battles
...
NNavy = {
	...
	NAVAL_COMBAT_AIR_SUB_TARGET_SCORE = 100,                             -- scoring for target picking for planes inside naval combat, one define per ship typ
	NAVAL_COMBAT_AIR_CAPITAL_TARGET_SCORE = 250,
	NAVAL_COMBAT_AIR_CARRIER_TARGET_SCORE = 150,
	NAVAL_COMBAT_AIR_CONVOY_TARGET_SCORE = 20,
	NAVAL_COMBAT_AIR_STRENGTH_TARGET_SCORE = 10,                         -- how much score factor from low health (scales between 0->this number)
