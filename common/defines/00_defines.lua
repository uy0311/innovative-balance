...
NCountry = {
	...
	SCORCHED_EARTH_STATE_COST = 100,					-- pp cost to scorch a state
...
NAir = {
	...
	COMBAT_DAMAGE_SCALE_CARRIER = 6.3,					-- same as above but used inside naval combat for carrier battles
	...
	NAVAL_STRIKE_DAMAGE_TO_STR = 0.6,					-- Balancing value to convert damage ( naval_strike_attack * hits ) to Strength reduction.
	...
	NAVAL_COMBAT_EXTERNAL_PLANES_MIN_CAP = 10,			-- Min cap for planes that can join naval combat
	...
	DISRUPTION_FACTOR = 5.5,									-- multiplier on disruption damage to scale its effects on planes
	...
	THRUST_WEIGHT_SPEED_FACTOR = 0,								-- For plane designs, additive Km/h max speed bonus per point of thrust exceeding weight
...
NNavy = {
	...
	ANTI_AIR_ATTACK_TO_AMOUNT = 0.00075,								-- Balancing value to convert equipment stat anti_air_attack to the random % value of airplanes being hit.
