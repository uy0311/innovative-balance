...
NProduction = {
	...
	BASE_FACTORY_EFFICIENCY_FAMILY_CHANGE_FACTOR = 90,		-- Base factor for changing production with same family in %.
...
NMilitary = {
	...
	LAND_AIR_COMBAT_STR_DAMAGE_MODIFIER = 0.2,    -- air global strength damage modifier
	LAND_AIR_COMBAT_ORG_DAMAGE_MODIFIER = 0.15,    	-- air global organization damage modifier
	...
	FIELD_EXPERIENCE_MAX_PER_DAY = 0.00,				-- Most xp you can gain per day
	...
	COMBAT_OVER_WIDTH_PENALTY_MAX = -0.525,			-- over combat width max (when you cant join no more).
