...
NMilitary = {
	...
	UNIT_EXP_LEVELS = { 0.1, 0.25, 0.4, 0.6 },		-- Experience needed to progress to the next level
	...
	COMBAT_OVER_WIDTH_PENALTY_MAX = -0.7,			-- over combat width max (when you cant join no more).
...
NAir = {
	...
	COMBAT_BETTER_AGILITY_DAMAGE_REDUCTION = 1.35, 		-- How much the better agility (than opponent's) can reduce their damage to us.
	COMBAT_BETTER_SPEED_DAMAGE_INCREASE = 2.6, 			-- How much the better Speed (than opponent's) can reduce increase our damage to them.
	...
	ESCORT_AGILITY_FACTOR = 5.0,
	ESCORT_ATTACK_FACTOR = 1.4,
...
NSupply = {
	...
	NAVAL_BASE_FLOW = 50.0, -- max output/input of a naval node is limited by this base value + additional ratio for each level
